...
maruthi.start();  // child class method
...
//Parent class varaible is holding child class object -- vimp 
// one proprty, and one method not availanle in parent calss
let car:Car=new Honda("Honda","Red","Honda city", 2024);


car.displayInformation();  //Name: Honda, Color: Red, Model: Honda city
car.start(); //Honda started.  // will call child class overrided method

//car.yom();   // Not accessible- bcoz yom() defeind inside th child class, but not in the parent class